...
// End Cross Module References
	DEFINE_FUNCTION(AFPSCharacter::execServerFired)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		if (!P_THIS->ServerFired_Validate())
		{
			RPC_ValidateFailed(TEXT("ServerFired_Validate"));
			return;
		}
		P_THIS->ServerFired_Implementation();
		P_NATIVE_END;
	}
	static FName NAME_AFPSCharacter_ServerFired = FName(TEXT("ServerFired"));
	void AFPSCharacter::ServerFired()
	{
		ProcessEvent(FindFunctionChecked(NAME_AFPSCharacter_ServerFired),NULL);
	}
	void AFPSCharacter::StaticRegisterNativesAFPSCharacter()
	{
		UClass* Class = AFPSCharacter::StaticClass();
		static const FNameNativePtrPair Funcs[] = {
			{ "ServerFired", &AFPSCharacter::execServerFired },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_AFPSCharacter_ServerFired_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFPSCharacter_ServerFired_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/FPSCharacter.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_AFPSCharacter_ServerFired_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFPSCharacter, nullptr, "ServerFired", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x80280CC0, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFPSCharacter_ServerFired_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFPSCharacter_ServerFired_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFPSCharacter_ServerFired()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFPSCharacter_ServerFired_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFPSCharacter_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFPSCharacter_ServerFired, "ServerFired" }, // 2014885464
	};
#if WITH_METADATA
	...
	UClass* Z_Construct_UClass_AFPSCharacter()
	{
		...
		if (!OuterClass)
		{
			UECodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AFPSCharacter_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AFPSCharacter, 701889785);
